...
8. 选择 **Web1** Web 活动，然后选择 **“设置”** 选项卡。按如下所示填写表单：
    ...
    1. **URL**： 粘贴从前面的步骤 4 中复制的 Key Vault 机密标识符值，然后将 `?api-version=7.0` **追加**到此值的末尾。例如，它类似于下面这样： `https://asakeyvaultNNNNN.vault.azure.net/secrets/PipelineSecret/f808d4fa99d84861872010f6c8d25c68?api-version=7.0`.
